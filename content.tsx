...
class LinkedInAiAssistant {
  ...
  public async initialize() {
    ...
    if (!isLinkedInFeedPage()) {
      console.log('[LinkedIn AI Assistant] Not a LinkedIn feed page, skipping initialization');
      return;
    }
  ...
  private async handlePostVisible(postElement: Element) {
    try {
      ...
      if (this.performanceManager.hasButton(postElement)) {
        console.log('[LinkedIn AI Assistant] ⏭️ Post already processed, skipping');
        return;
      }
      ...
      if (existingButtons.length > 0) {
        console.log('[LinkedIn AI Assistant] ⏭️ Button already exists in action bar, skipping');
